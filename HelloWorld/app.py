...
members = ["vance", "chris", "jack", "dj", "kirby"]
leader = random.choice(members)
print(leader)

# Exercise make a dice roll using tuples
# my attempt
numbs6 = (1, 2, 3, 4, 5, 6)

# for j in range(2):
#     roll = random.choice(numbs6)
#     print(roll)
...
# My attemot works by giving me two numbers but we can make it shorter and cleaner
